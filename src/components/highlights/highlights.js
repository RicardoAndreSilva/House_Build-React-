    ...
    return (
       //---Section highlights-- >
        <section className="highlights container">
            <div className="highlights__first">
                <div className="highlights__action">
                    <svg preserveAspectRatio="xMidYMid meet" data-bbox="20.005 16.396 160 167.324"
                        viewBox="20.005 16.396 160 167.324" height="200" width="200" xmlns="http://www.w3.org/2000/svg"
                        data-type="color" role="presentation" aria-hidden="true" aria-labelledby="svgcid-5kxts184k1j">
                        <g>
                            <path fill="#978673" d="M162.524 183.72H37.486V81.18h3.746v98.793h117.545V81.18h3.747v102.54z"
                                data-color="1"></path>
                            <path fill="#978673"
                    ...
                    <p className="highlights__text">ampla experiência</p>
                </div>
            </div>
            <div className="highlights__second">
                <div className="highlights__action">
                    <svg preserveAspectRatio="xMidYMid meet" data-bbox="20 20 160 160" viewBox="20 20 160 160" height="200"
                        ...
                        aria-labelledby="svgcid-g1epra-kl5w8h">
                        <g>
                            <path d="M180 180H20V20h160v160zm-156.098-3.902h152.195V23.902H23.902v152.196z" fill="#978673"
                                data-color="1"></path>
                            <path
                    ...
                    <p className="highlights__text">equipe profissional</p>
                </div>
            </div>
            <div className="highlights__third">
                <div className="highlights__action">
                    <svg preserveAspectRatio="xMidYMid meet" data-bbox="20 20 160 160" viewBox="20 20 160 160" height="200"
                        width="200" xmlns="http://www.w3.org/2000/svg" data-type="color" role="presentation" aria-hidden="true"
                        aria-labelledby="svgcid--jo58vs-fbtm8x">
                        <g>
                            <path
                    ...
                    <p className="highlights__text">acabamento impecável</p>
                </div>
            </div>
            <div className="highlights__fourth">
                <div className="highlights__action">
                    <svg preserveAspectRatio="xMidYMid meet" data-bbox="20 23.185 160 153.629" viewBox="20 23.185 160 153.629"
                        height="200" width="200" xmlns="http://www.w3.org/2000/svg" data-type="color" role="presentation"
                        aria-hidden="true" aria-labelledby="svgcid--kmarxt-og6ty3">
                        <g>
                            <path
                    ...
                    <p className="highlights__text">sustentabilidade e transparência</p>
                </div>
            </div>
        </section>
    );
